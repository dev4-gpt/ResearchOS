...
\begin{enumerate}
  ...
  \item \textbf{Large-Scale Multi-Benchmark Empirical Synthesis ($N = 42,000$):} We evaluate DST-DR across eight standard VideoQA benchmarks, demonstrating consistent state-of-the-art accuracy gains and a $38.4\%$ compute FLOPs reduction ($p < 0.001$).
