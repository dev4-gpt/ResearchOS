...
for folder in ['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p']:
    dirpath = os.path.join('papers', folder)
    if os.path.exists(dirpath):
        shutil.rmtree(dirpath)
    os.makedirs(dirpath, exist_ok=True)
print("Cleared old directories: p1, p2, p3, p4, p5, p6, p7, p8, p9, p")

# STEP 2: Execute fresh Publisher Readiness Run
print("\n>>> STEP 2: Running fresh release build across all 9 drafts and 12 venues...")
t0 = time.time()
report = prs.run()
...
# STEP 4: Populate individual folders papers/p1..p9
print("\n>>> STEP 4: Deploying filtered topic packages to papers/p1 through papers/p9...")
mapping = {
    ...
    'p6': ('review_continual_safety_alignment_in_vision_language_models', 'Continual Safety Alignment in Vision-Language Models: Mitigating Multi-Stage Drift Across Pre-Training, Supervised Fine-Tuning, and Task Adaptation'),
    'p7': ('review_composable_ai_systems_for_trustworthy_agentic_pipelines', 'Composable AI Systems: Modular Architecture Patterns for Trustworthy Agentic Pipelines'),
    'p8': ('review_spatio_temporal_grounding_in_video_question_answering', 'Spatio-Temporal Grounding and Multimodal Reasoning in Video Question Answering: Overcoming Cross-Modal Attention Collapse'),
    'p9': ('review_trustworthy_multi_agent_systems_formal_verification', 'Trustworthy Multi-Agent Systems: Formal Contract Verification, Decentralized Governance, and Zero-Hallucination Consensus')
}
