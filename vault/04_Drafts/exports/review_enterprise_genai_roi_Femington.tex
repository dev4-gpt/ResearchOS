...
\noindent\textbf{Keywords---} Return, Investment, Governance, Adoption, Genai, Literature.
...
Property & Value \\
\midrule
Run identifier & \texttt{draft-review\_enterprise\_genai\_roi} \\
Random seed & 20260825 \\
Repository revision & \texttt{cbc42b88617a} \\
Python & 3.13.5 \\
Platform & macOS-26.5.2-arm64-arm-64bit-Mach-O \\
Architecture & arm64 \\
Logical CPUs & 12 \\
Accelerator & none; no GPU was used at any point \\
Wall-clock duration & \texttt{21.582 s} \\
...
\midrule
\texttt{literature\_distinct\_venues} & 714.0 & n & 1779 & -- & \texttt{distinct primary sources} \\
\texttt{literature\_empirical\_share} & 31.76 & \% & 1779 & -- & \texttt{abstract contains a sample-size or study marker} \\
\texttt{literature\_empirical\_share\_ci\_low} & 29.566 & \% & 1779 & -- & \texttt{bootstrap lower bound on empirical share} \\
\texttt{literature\_identified\_total} & 2000.0 & n & 1779 & -- & \texttt{sum of per-query result counts} \\
\texttt{literature\_median\_citations} & 62.0 & n & 1779 & -- & \texttt{median of cited\_by\_count} \\
\texttt{literature\_open\_access\_share} & 98.54 & \% & 1779 & -- & \texttt{OpenAlex is\_oa flag} \\
\texttt{literature\_recent\_share} & 68.63 & \% & 1779 & -- & \texttt{publication year $>$= 2023} \\
\texttt{literature\_screened} & 1779.0 & n & 1779 & -- & \texttt{abstract and title present} \\
\texttt{literature\_unique\_after\_dedup} & 1893.0 & n & 1779 & -- & \texttt{deduplicated by OpenAlex id} \\
\texttt{literature\_zero\_citation\_share} & 0.51 & \% & 1779 & -- & \texttt{share with cited\_by\_count == 0} \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{artifacts/literature\_census.json} & \texttt{b96a25dbca78848f} \\
\bottomrule
\end{tabular}}
\end{table}
