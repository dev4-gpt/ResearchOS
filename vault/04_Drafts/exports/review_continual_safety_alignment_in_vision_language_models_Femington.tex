...
\noindent\textbf{Keywords---} What, Moves, Safety, Subspace, Geometric, Account.
...
\begin{itemize}
  \item \textbf{Magnitude rule.} Retain the $\kappa$ fraction with smallest $\|\Delta W_i\|$.
...
Property & Value \\
\midrule
Run identifier & \texttt{draft-review\_continual\_safety\_alignment\_in\_vision\_language\_models} \\
Random seed & 20260825 \\
Repository revision & \texttt{3588bc9f677c} \\
Python & 3.13.5 \\
Platform & macOS-26.5.2-arm64-arm-64bit-Mach-O \\
Architecture & arm64 \\
Logical CPUs & 12 \\
Accelerator & none; no GPU was used at any point \\
Wall-clock duration & \texttt{41.155 s} \\
...
\midrule
\texttt{discard\_fraction\_pct\_keep0\_7} & 30.0 & \% & 1500 & -- & \texttt{share of the batch withheld by the selection rule} \\
\texttt{discard\_fraction\_pct\_keep0\_8} & 20.0 & \% & 1500 & -- & \texttt{share of the batch withheld by the selection rule} \\
\texttt{discard\_fraction\_pct\_keep0\_9} & 10.0 & \% & 1500 & -- & \texttt{share of the batch withheld by the selection rule} \\
\texttt{drift\_deg\_leakage0\_0} & 0.0 & -- & 200 & -- & \texttt{mean principal angle at fixed update norm, varying orthogonal leakage} \\
\texttt{drift\_deg\_leakage0\_25} & 1.808 & -- & 200 & -- & \texttt{mean principal angle at fixed update norm, varying orthogonal leakage} \\
\texttt{drift\_deg\_leakage0\_5} & 4.035 & -- & 200 & -- & \texttt{mean principal angle at fixed update norm, varying orthogonal leakage} \\
\texttt{drift\_deg\_leakage0\_75} & 5.397 & -- & 200 & -- & \texttt{mean principal angle at fixed update norm, varying orthogonal leakage} \\
\texttt{drift\_deg\_leakage1\_0} & 5.686 & -- & 200 & -- & \texttt{mean principal angle at fixed update norm, varying orthogonal leakage} \\
\texttt{drift\_deg\_norm0\_05} & 0.124 & -- & 400 & [0.124, 0.124] & \texttt{mean principal angle between original and updated safety subspace} \\
\texttt{drift\_deg\_norm0\_1} & 0.248 & -- & 400 & [0.248, 0.248] & \texttt{mean principal angle between original and updated safety subspace} \\
\texttt{drift\_deg\_norm0\_2} & 0.496 & -- & 400 & [0.496, 0.497] & \texttt{mean principal angle between original and updated safety subspace} \\
\texttt{drift\_deg\_norm0\_4} & 0.992 & -- & 400 & [0.991, 0.993] & \texttt{mean principal angle between original and updated safety subspace} \\
\texttt{drift\_deg\_norm0\_8} & 1.983 & -- & 400 & [1.982, 1.985] & \texttt{mean principal angle between original and updated safety subspace} \\
\texttt{drift\_deg\_norm1\_6} & 3.963 & -- & 400 & [3.96, 3.966] & \texttt{mean principal angle between original and updated safety subspace} \\
\texttt{drift\_deg\_rank16} & 0.992 & -- & 150 & -- & \texttt{mean principal angle at fixed update norm} \\
\texttt{drift\_deg\_rank32} & 0.972 & -- & 150 & -- & \texttt{mean principal angle at fixed update norm} \\
\texttt{drift\_deg\_rank4} & 1.009 & -- & 150 & -- & \texttt{mean principal angle at fixed update norm} \\
\texttt{drift\_deg\_rank64} & 0.93 & -- & 150 & -- & \texttt{mean principal angle at fixed update norm} \\
\texttt{drift\_deg\_rank8} & 1.003 & -- & 150 & -- & \texttt{mean principal angle at fixed update norm} \\
\texttt{drift\_growth\_exponent} & 0.9994 & exponent & 6 & -- & \texttt{log-log fit of mean drift against update norm} \\
\texttt{drift\_removed\_keep0\_7} & 65.38 & \% & 2000 & -- & \texttt{share of total subspace rotation removed by the selection rule} \\
\texttt{drift\_removed\_keep0\_8} & 52.81 & \% & 2000 & -- & \texttt{share of total subspace rotation removed by the selection rule} \\
\texttt{drift\_removed\_keep0\_9} & 35.26 & \% & 2000 & -- & \texttt{share of total subspace rotation removed by the selection rule} \\
\texttt{drift\_removed\_keep0\_95} & 22.53 & \% & 2000 & -- & \texttt{share of total subspace rotation removed by the selection rule} \\
\texttt{drift\_removed\_leakfilter\_keep0\_7} & 44.69 & \% & 1500 & -- & \texttt{drift removed by discarding the highest-leakage updates} \\
\texttt{drift\_removed\_leakfilter\_keep0\_8} & 29.61 & \% & 1500 & -- & \texttt{drift removed by discarding the highest-leakage updates} \\
\texttt{drift\_removed\_leakfilter\_keep0\_9} & 15.08 & \% & 1500 & -- & \texttt{drift removed by discarding the highest-leakage updates} \\
\texttt{drift\_removed\_normfilter\_keep0\_7} & 62.87 & \% & 1500 & -- & \texttt{drift removed by discarding the largest-magnitude updates} \\
\texttt{drift\_removed\_normfilter\_keep0\_8} & 50.24 & \% & 1500 & -- & \texttt{drift removed by discarding the largest-magnitude updates} \\
\texttt{drift\_removed\_normfilter\_keep0\_9} & 33.3 & \% & 1500 & -- & \texttt{drift removed by discarding the largest-magnitude updates} \\
\texttt{drift\_spread\_across\_ranks} & 0.079 & -- & 5 & -- & \texttt{range of mean drift across assumed ranks 4 to 64} \\
\texttt{leakage\_drift\_ratio\_max\_over\_min} & 5.6863 & -- & 200 & -- & \texttt{drift at full leakage minus drift at zero, both at norm 0.4} \\
\texttt{selection\_efficiency\_keep0\_7} & 0.999 & x & 2000 & -- & \texttt{drift removed per unit of update mass removed} \\
\texttt{selection\_efficiency\_keep0\_8} & 0.999 & x & 2000 & -- & \texttt{drift removed per unit of update mass removed} \\
\texttt{selection\_efficiency\_keep0\_9} & 0.999 & x & 2000 & -- & \texttt{drift removed per unit of update mass removed} \\
\texttt{selection\_efficiency\_keep0\_95} & 0.998 & x & 2000 & -- & \texttt{drift removed per unit of update mass removed} \\
\texttt{signal\_removed\_keep0\_7} & 65.41 & \% & 2000 & -- & \texttt{share of total update magnitude removed by the same rule} \\
\texttt{signal\_removed\_keep0\_8} & 52.84 & \% & 2000 & -- & \texttt{share of total update magnitude removed by the same rule} \\
\texttt{signal\_removed\_keep0\_9} & 35.3 & \% & 2000 & -- & \texttt{share of total update magnitude removed by the same rule} \\
\texttt{signal\_removed\_keep0\_95} & 22.56 & \% & 2000 & -- & \texttt{share of total update magnitude removed by the same rule} \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{artifacts/drift\_by\_norm.json} & \texttt{d4d915c4c08b5077} \\
\texttt{artifacts/filter\_comparison.json} & \texttt{3d81576d3172d485} \\
\texttt{artifacts/leakage\_effect.json} & \texttt{b55e1e368ef96786} \\
\texttt{artifacts/rank\_sensitivity.json} & \texttt{266dc78424f564a4} \\
\texttt{artifacts/selection\_effect.json} & \texttt{b5294b57ed449856} \\
\bottomrule
\end{tabular}}
\end{table}
