...
citations: "0"
source: "Crossref"
id: "crossref:10.70175/hclreview.2020.34.3.1"
...
The central thesis of this research is that AI does not act as a uniform elevator of capability. Instead, its capability boundary is "jagged":
* **Within-Frontier Tasks:** Tasks where AI capabilities are mature. AI integration leads to dramatic performance and efficiency gains.
* **Beyond-Frontier Tasks:** Complex, contextual, or multi-step reasoning tasks where AI capability is deficient. AI integration here leads to a degradation of output quality due to human [[Overreliance]] and automated errors.
...
The paper draws on empirical field experimental data from a cohort of **758 consultants** at the [[Boston Consulting Group]]. The results vary sharply depending on whether the task falls within or outside the technological frontier:

### 1. Inside the Capability Frontier (AI-Assisted vs. Control)
For tasks lying within the AI's capability frontier, AI assistance yielded substantial positive performance deltas:
* **Task Volume Increase:** $+12.2\%$ more tasks completed.
* **Execution Velocity:** Completed tasks $25.1\%$ faster.
* **Output Quality:** Achieved qualitatively higher outcomes compared to the non-AI control group.

### 2. Outside the Capability Frontier (Complex Tasks)
For complex tasks situated beyond the technological frontier, AI assistance introduced severe performance liabilities:
* **Accuracy Degradation:** AI users were $19\%$ less likely to produce correct solutions compared to their non-assisted counterparts.
* **Underlying Driver:** Systemic [[Overreliance]] on AI outputs without sufficient critical oversight or validation.

| Metric | Within-Frontier Tasks | Beyond-Frontier Tasks |
| :--- | :--- | :--- |
...
To navigate the risks of the jagged frontier, the paper outlines three critical organizational interventions:

```
                  ┌─────────────────────────────────────────┐
                  │      AI Organizational Integration      │
                  └────────────────────┬────────────────────┘
                                       │
         ┌─────────────────────────────┼─────────────────────────────┐
         ▼                             ▼                             ▼
┌─────────────────┐           ┌─────────────────┐           ┌─────────────────┐
│   Structured    │           │  Human Judgment │           │    Workflow     │
│   Evaluation    │           │   Capabilities  │           │    Redesign     │
│   Frameworks    │           │   Development   │           │    Optima       │
└─────────────────┘           └─────────────────┘           └─────────────────┘
```

1. **Structured Evaluation Frameworks:** Organizations must systematically map tasks to identify whether they lie inside or outside the current technological frontier.
