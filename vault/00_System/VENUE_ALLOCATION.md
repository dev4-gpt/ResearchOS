...
One venue per manuscript. Concurrent submission of the same paper to multiple venues is prohibited by all of them, so the 12-venue build matrix is for formatting only.
...
| review_enterprise_adoption_of_multi_agent_ai | arXiv | preprint | 3.8 | 90 | 2.0 |
| review_enterprise_genai_roi | arXiv | preprint | 6.4 | 3 | 20.0 |
| review_spatio_temporal_grounding_in_video_qu | arXiv | preprint | 4.3 | 95 | 2.0 |
| review_symbol_graph_rag_vs_qlora_swe_bench_l | arXiv | preprint | 4.8 | 87 | 2.0 |
| review_trustworthy_multi_agent_systems_forma | arXiv | preprint | 3.8 | 99 | 2.0 |
...
**Target:** arXiv
- Under-built: ~3.8 pages against a 20-page venue (16.2 pages short) (+5).
- Acceptance weight +15.0.
- Already used by another manuscript in this batch (-18).
- ⚠️ Preprint server; no peer review, so it never counts as a publication.
...
**Target:** arXiv
- Under-built: ~6.4 pages against a 20-page venue (13.6 pages short) (+5).
- Acceptance weight +15.0.
- ⚠️ Preprint server; no peer review, so it never counts as a publication.
...
**Target:** arXiv
- Under-built: ~4.8 pages against a 20-page venue (15.2 pages short) (+5).
- Acceptance weight +15.0.
- Already used by another manuscript in this batch (-18).
- ⚠️ Preprint server; no peer review, so it never counts as a publication.
